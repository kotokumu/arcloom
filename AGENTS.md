...
Read only the documents relevant to the current work. When work spans multiple rows, read each applicable document.
...
| Design, implementation, testing, or review | `docs/DEVELOPMENT.md` |
