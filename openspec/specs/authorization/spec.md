...
- **Behavioral Rules**:
  ...
  |---|---|---|---|---|
  | Deny overrides | Policy is valid | At least one applicable Rule yields Deny | Denied | None |
  | All permit | Policy is valid and no Rule yields Deny | Every applicable Rule yields Permit | Authorized | None |
  | Otherwise | Policy is valid and no Rule yields Deny | At least one applicable Rule does not yield Permit | Undecidable | None |
