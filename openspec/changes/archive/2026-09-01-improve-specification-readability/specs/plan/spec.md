...
- FROM: `### Requirement: PLN-1 Plan vocabulary`
- TO: `### Requirement: plan-vocabulary`
- FROM: `### Requirement: PLN-2 Plan text`
- TO: `### Requirement: plan-text`
- FROM: `### Requirement: PLN-3 Collection invariants`
- TO: `### Requirement: collection-invariants`
- FROM: `### Requirement: PLN-4 Target date`
- TO: `### Requirement: target-date`
- FROM: `### Requirement: PLN-5 Validation result and Plan validity`
- TO: `### Requirement: validation-result-and-plan-validity`
