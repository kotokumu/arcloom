...
- **GIVEN** a target-specific Attempt returns a non-nil error together with any successful value and any valid or invalid Directive
- **WHEN** the Controller processes that return
